...
public class VirusPopupManager : MonoBehaviour
{
    ...
    [SerializeField] private Transform computerAppsUI;
    ...
    private void Start()
    {
        foreach (Transform appsIcon in computerAppsUI)
        {
            appsIcon.gameObject.SetActive(!appsIcon.gameObject.activeSelf);
        }
